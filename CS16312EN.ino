...
/****************************************************/
#define VFD_in 8// Data In & Data Out ot panel(use a resisor of 22ohms to joint both ports before connect at pin 8 of Arduino)
#define VFD_clk 9 // This is the pin to provide the clock signal to the panel.
#define VFD_stb 10 // Allow the communications be well defined after catch the kind of instruction arrive!
...
void readButtons(){
  int inPin = 8;// Will be reassign pin 8 as input to read the pushbutton connected to digital pin 8
...
void loop() {
  ...
  clear_VFD();
   while(1){
    send_update_clock();
    delay(200);
    readButtons();//Because is inside of the cycle, is necessary keep press on button some time to do action
    delay(200);
    CS16312EN_RunWeels();
   }
}
ISR(TIMER1_COMPA_vect)   {  //This is the interrupt request
      secs++;  //I only increment seconds, all other values is base on it!
} 
